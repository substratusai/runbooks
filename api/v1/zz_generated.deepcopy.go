...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelTrainingParams) DeepCopyInto(out *ModelTrainingParams) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelTrainingParams.
func (in *ModelTrainingParams) DeepCopy() *ModelTrainingParams {
	if in == nil {
		return nil
	}
	out := new(ModelTrainingParams)
	in.DeepCopyInto(out)
	return out
}
