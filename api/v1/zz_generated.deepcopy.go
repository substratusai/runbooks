...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatasetLoader) DeepCopyInto(out *DatasetLoader) {
	*out = *in
	if in.Params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatasetLoader.
func (in *DatasetLoader) DeepCopy() *DatasetLoader {
	if in == nil {
		return nil
	}
	out := new(DatasetLoader)
	in.DeepCopyInto(out)
	return out
}
